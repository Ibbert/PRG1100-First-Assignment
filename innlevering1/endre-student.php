  ...
  if (isset($_POST ["endreStudent"]))
    {
      ...
      print ("Klassekode <select name='klassekode' id='klassekode'>"); print("<option value=''>$klassekode</option>"); listeboksKlasse($klassekode); print ("</select> <br />");
      print ("Bildenummer <select name='bildeNr' id='bildeNr'>"); print("<option value='$bildeNr'>$bildeNr</option>"); listeboksBildenr($bildeNr); print ("</select> <br />"); 
  ...
  if (isset($_POST ["endreStudentKnapp"]))
    {
     ...
     if (!$fornavn || !$fornavn)
        {
          print ("Fornavn og etternavn må fylles ut");
        }
      else
        {
